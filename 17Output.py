...
def LexerForJava(string):
    ...
    plus_op = r'\+'
    KEYWORDS = specialsymbols + other_symbols + keywords + separators + operators + types + escapes
    # Reads data
    white_space = ' '
    lexeme = ''
...
def LexerForPython(string):
    ...
    KEYWORDS = special_symbols + other_symbols + keywords  + separators + operators + types + escapes
    # Reads data
    white_space = ' '
    coments = "#"
    lexeme = ''
...
def LexerForSQL(string):
    ...
    escapes = [r"\n", r"\t", r"\v", r"\b",r"\r",r"\f",r"\a",r"\\",r"\'",r'\"' "//","/"]
    plus_op = [r'\+']
    KEYWORDS = specialsymbols + other_symbols + keywords + separators + operators + numeric_types + escapes + \
